...
describe("affine point", () => {
	test("from compressed secp256r1", () => {
		...
		expect(affinePoint.x).toStrictEqual(
			0x6b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296n,
		)
		expect(affinePoint.y).toStrictEqual(
	...
	test("compress and decompress secp256r1 generator point", () => {
		...
		expect(affinePoint.compressedForm.length).toBe(33)
		expect(affinePoint.decompressedForm.length).toBe(65)

		expect(bytesToBigint(affinePoint.compressedForm)).toStrictEqual(
			0x036b17d1f2e12c4247f8bce6e563a440f277037d812deb33a0f4a13945d898c296n,
		)

		expect(bytesToBigint(affinePoint.decompressedForm)).toStrictEqual(
	...
	test("compress and decompress secp384r1 generator point", () => {
		...
		expect(affinePoint.compressedForm.length).toBe(49)
		expect(affinePoint.decompressedForm.length).toBe(97)
	...
	test("compress and decompress secp521r1 generator point", () => {
		...
		expect(affinePoint.compressedForm.length).toBe(66)
		expect(affinePoint.decompressedForm.length).toBe(132)
